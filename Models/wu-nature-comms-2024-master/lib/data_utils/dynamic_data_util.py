...
try:
    ...
    RAWMOVIE_AVAILABLE = True
except ImportError:
    load_movie = None
    RAWMOVIE_AVAILABLE = False

try:
    import spikebinning
    SPIKEBINNING_AVAILABLE = True
except ImportError:
    spikebinning = None
    SPIKEBINNING_AVAILABLE = False

try:
    from movie_upsampling import compute_interval_overlaps, integer_upsample_movie
    MOVIE_UPSAMPLING_AVAILABLE = True
except ImportError:
    compute_interval_overlaps = None
    integer_upsample_movie = None
    MOVIE_UPSAMPLING_AVAILABLE = False

try:
    import visionloader as vl
    VISIONLOADER_AVAILABLE = True
except ImportError:
    # Create a dummy module for type hints
    class DummyVisionModule:
        class VisionCellDataTable:
            pass
    vl = DummyVisionModule()
    VISIONLOADER_AVAILABLE = False
