...
try:
    ...
    # Fallback to tensorflow.keras for newer versions
    from tensorflow.keras.models import Model
    from tensorflow.keras.layers import Dense, Activation, Flatten, Reshape, Conv2D, BatchNormalization, GaussianNoise
