...
from config import BASE_PATH, get_device

IMAGES_PATH = os.path.join(BASE_PATH, 'processed_data', 'natural_scenes.h5')
SPIKES_PATH = os.path.join(BASE_PATH, 'processed_data', 'training_dataset_ns_full.h5')
...
def main():
    ...
    ckpt_path = os.path.join(CHECKPOINTS_DIR, "foveated_drift_model_final.pth")
    curve_path = os.path.join(CHECKPOINTS_DIR, "foveated_training_curve.png")
